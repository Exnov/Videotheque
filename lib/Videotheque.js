...
var Videotheque = /*#__PURE__*/function (_React$Component) {
  _inherits(Videotheque, _React$Component);

  var _super = _createSuper(Videotheque);

  function Videotheque() {
    _classCallCheck(this, Videotheque);

    return _super.apply(this, arguments);
  }

  _createClass(Videotheque, [{
    key: "renderNameMedias",
    value: function renderNameMedias(clip) {
      //renvoie la liste des videos à partir de leur numero
      var nameMedias = [];
    ...
    key: "renderVideotheque",
    value: function renderVideotheque() {
